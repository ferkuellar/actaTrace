...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="actatrace-api", alias="SERVICE_NAME")
    ...
    enable_health_ready: bool = Field(default=True, alias="ENABLE_HEALTH_READY")
    ...
    grafana_admin_password: str = Field(default="change-me", alias="GRAFANA_ADMIN_PASSWORD")
    alert_hash_mismatch_threshold: int = Field(default=1, alias="ALERT_HASH_MISMATCH_THRESHOLD")
    alert_prep_mismatch_threshold: int = Field(default=1, alias="ALERT_PREP_MISMATCH_THRESHOLD")
    alert_api_error_rate_threshold: float = Field(default=0.05, alias="ALERT_API_ERROR_RATE_THRESHOLD")
    alert_api_latency_p95_seconds: float = Field(default=1.5, alias="ALERT_API_LATENCY_P95_SECONDS")
